...
perl moirai2.pl \
-d singlecell.sqlite3 \
-i 'singlecell->#userdefinedid->$userdefinedid' \
-o '$userdefinedid->#studyid->$studyid,singlecell->#studyid->$studyid' \
https://moirai2.github.io/command/edirect/userdefinedid_to_studyid.json
...
https://moirai2.github.io/command/edirect/studyid_to_sra_info_files.json \
'$runinfo=$studyid/$studyid.runinfo.txt' \
'$summary=$studyid/$studyid.summary.txt'
...
https://moirai2.github.io/command/edirect/import_runinfo_to_database.json \
...
https://moirai2.github.io/command/sratoolkit/fastq_dump_paired.json \
'$read1=$studyid/fastq/$studyid.$runid.read1.fq.gz' \
'$read2=$studyid/fastq/$studyid.$runid.read2.fq.gz'

perl moirai2.pl \
-d singlecell.sqlite3 \
-i '$studyid->#Run->$runid,$runid->#LibraryLayout->SINGLE' \
-o '$runid->#read1->$read1,$runid->#count1->$count1' \
https://moirai2.github.io/command/sratoolkit/fastq_dump_single.json \
'$read1=$studyid/fastq/$studyid.$runid.read1.fq.gz'
...
https://moirai2.github.io/command/tagdust/tagdust_paired.json \
'$log=data/filtered/$studyid.$runid.log' \
...
https://moirai2.github.io/command/STAR/remove_multimap_single.json \
